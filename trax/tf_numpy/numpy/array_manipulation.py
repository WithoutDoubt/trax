...
def hstack(tup):
  unwrapped_arrays = [math_lib.atleast_1d(a) for a in tup]
...
def vstack(tup):
  unwrapped_arrays = [math_lib.atleast_2d(a) for a in tup]
  unwrapped_arrays = array_creation._promote_dtype(*unwrapped_arrays)
...
def dstack(tup):
  unwrapped_arrays = [math_lib.atleast_3d(a) for a in tup]
  unwrapped_arrays = array_creation._promote_dtype(*unwrapped_arrays)
